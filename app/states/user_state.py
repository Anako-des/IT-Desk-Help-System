...
class UserState(rx.State):
    users: list[User] = [
        {
            "userName": "rhernandez",
            "name": "Juan Carlos Hernandez Palacios",
            "email": "jhernandez@matrix-sanmargroup.com",
            "contrasenna": "pass123",
            "area": "IT",
        },
        {
            "userName": "rperez",
            "name": "Ana Rebeca Perez Garcia",
            "email": "pit@matrix-sanmargroup.com",
            "contrasenna": "pass123",
            "area": "IT",
        },
        {
            "userName": "gbaez",
            "name": "Gerardo Baez",
            "email": "gbaez2@matrix-sanmargroup.com",
            "contrasenna": "pass123",
            "area": "IT",
        },
        {
            "userName": "mlopez",
            "name": "Mariana Lopez Cruz",
        ...
        {
            "userName": "vromero",
            "name": "Valeria Romero Peña",
            "email": "vromero@example.com",
            "contrasenna": "pass123",
            "area": "Producción",
        },
        {
            "userName": "fnavarro",
            "name": "Fernando Navarro Ríos",
            "email": "fnavarro@example.com",
            "contrasenna": "pass123",
            "area": "Ventas",
        },
        {
            "userName": "svega",
            "name": "Sandra Vega Luna",
